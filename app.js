...
function checkIfValid(target) {
    ...
    switch(piece) {
        case 'pawn':
            ...
            if (
                starterRow.includes(startId) && !document.querySelector(`[square-id="${startId - WIDTH}"]`).firstChild && startId - WIDTH * 2 == targetId && !document.querySelector(`[square-id="${startId - WIDTH * 2}"]`).firstChild ||
